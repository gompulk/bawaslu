...
<div class="table-responsive">
	...
	<br>
		<a target="_blank" href="ekspor_excel.php" class="btn btn-success"><i class="fa fa-table"></i>&nbsp; EXPORT KE EXCEL</a>
	<br><br>
...
<a href="index.php?halaman=input" class="btn btn-primary">Tambah Data Pemilih</a>